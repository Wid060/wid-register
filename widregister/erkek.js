...
widmember.roles.cache.has(config.tag_role) ? widmember.roles.set([config.tag_role,  config.man_role, config.man_role2]) : widmember.roles.set([config.man_role, config.man_role2]);
